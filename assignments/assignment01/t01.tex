...
\mybox{Ventajas}{green!40}{green!10}{Reducción del riesgo en trabajos de altura.\\
  En coordinación con múltiples robots se puede maximizar la carga que pueden efectuar.\\
Se puede facilitar los trabajos de presición con movimientos suaves.}

\mybox{Desventajas}{red!40}{red!10}{Dificultad para el modelado de estos sistemas.\\
  El área de operación pudiera situarse por debajo ó arriba del Drone.\\
  La manipulación/teleoperación al ser de forma aislada (no repetitiva) deba ser guiada por un operador.}

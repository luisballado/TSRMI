...
\item{Identificar las funcionalidades de cada capa, así como el o los lenguajes de programación empleados en el desarrollo.}
  ...
  En el segundo artículo \textbf{Design of Hybrid Control Architecture for Mobile Robots}, también se mencionan tres componentes principales en la arquitectura híbrida propuesta:\\
  ...
  En cuanto al lenguaje de programación utilizado en el desarrollo de esta arquitectura, tampoco se especifica directamente en el artículo.
